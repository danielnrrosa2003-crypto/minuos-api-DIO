...
#region Home
//O React.Json não estava funcionando corretamente, após pesquisar um pouco melhor, opto por outro modo
app.MapGet("/", () =>
{
    var html = @"
        <html>
            <head>
                <title>Minuos API</title>
                <style>
                    body {
            ...
            <body>
                <h1> Bem-vindo a API de Veiculos - Minuos API</h1>
                <p>Acesse a documentacao clicando abaixo:</p>
                <a href=""/swagger"">Abrir Swagger</a>
            </body>
        </html>";
...
ErrosDeValidacao validaDTO(VeiculoDTO veiculoDTO)
{
    ...
    if (veiculoDTO.Ano < 1950)
        validacao.Mensagens.Add("Veiculo muito antigo, aceito somente anos superiores há década de 50 ");
